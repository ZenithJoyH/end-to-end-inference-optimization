...
patch_file="${case_root}/commands/add-thead-scaled-mm-prefill-configs-v2-20260916.patch"
record_dir="${case_root}/results/operators/scaled-mm-prefill-config-apply-20260916-02"
