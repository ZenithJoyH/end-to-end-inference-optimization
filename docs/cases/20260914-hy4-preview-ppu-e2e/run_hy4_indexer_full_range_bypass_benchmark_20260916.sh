...
tool="${case_dir}/commands/benchmark_hy4_indexer_full_range_bypass-r4-active-20260916.py"
output="${case_dir}/results/indexer-full-range-bypass-r4-active-20260916.jsonl"
