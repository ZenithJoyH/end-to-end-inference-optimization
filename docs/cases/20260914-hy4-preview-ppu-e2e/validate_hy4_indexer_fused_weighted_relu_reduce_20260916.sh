...
result="${case_dir}/results/plugin-indexer-exact-fused-pointwise-validation-20260916.txt"

test ! -e "${result}"
test "$(git -C "${repo}" rev-parse HEAD)" = 38f350b13fc15f08eb4641e1d6d1980ba3fc16aa
test "$(sha256sum "${repo}/vllm_fl/models/hy_v4.py" | awk '{print $1}')" = 7c1843727800a6e1bc5252c28aaf33f0801da672442aa4ad145c7ce613ec6ea2
