...
Usage:
 ...
 2. Run this profiling script:
    python evaluation/performance/vllm_profile.py --model MODEL --tokenizer TOKENIZER
...
def parse_args():
    ...
    parser.add_argument("--model", required=True, help="服务暴露的模型名")
    parser.add_argument("--tokenizer", required=True, help="tokenizer 路径或名称")
    parser.add_argument(
